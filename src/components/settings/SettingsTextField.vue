...
<template>
  <div class="settings-field flex flex-col gap-1.5 w-full">
    ...
    <div class="relative group">
      <input :type="type || 'text'" :value="modelValue ?? ''" :placeholder="placeholder" :disabled="disabled"
      ...
      <div v-if="error" class="absolute right-3 top-1/2 -translate-y-1/2 text-red-500 opacity-50 pointer-events-none">
